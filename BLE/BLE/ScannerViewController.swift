...
//MARK: Variables
    ...
    var selectedPeripheral2: CBPeripheral?
...
//MARK: UITableViewDataSource
    ...
    @IBAction func ConnectAllDevices(_ sender: UIButton) {
...
//        serial.connectToPeripheral(selectedPeripheral1!)
//        selectedPeripheral2 = peripherals[(indexPath as NSIndexPath).row + 1].peripheral
