...
String LOG_FILE_PREFIX = "headScenario";  // Prefix name for log files
String LOG_FILE_SUFFIX = ".txt";  // Suffix name for log files

String logFileName = "headScenario1.txt";
